class X2Helpers_MiscFunctions extends Object config (GameData);
...
public static function bool Log(optional bool bIsErrorMsg=false, optional bool bIsInformMsg=false)
{
	if (!default.bLogAll)

...
//-----------------------------------------------------------
class X2Action_PlayEffect_Advanced extends X2Action;
...
simulated state Executing
{
	simulated private function PlayEffect()
	{
		...
		else if (AttachToUnit)
		{
			...
			// EDIT BEGIN
			//If given a custom scale, then set the scale of the component
			if (EffectScale != 1.00f)
			{
				PSComponent.SetScale( EffectScale );
			}
			// EDIT END

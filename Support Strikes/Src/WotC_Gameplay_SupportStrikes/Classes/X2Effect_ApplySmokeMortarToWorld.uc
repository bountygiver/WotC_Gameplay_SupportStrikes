...
//---------------------------------------------------------------------------------------
class X2Effect_ApplySmokeMortarToWorld extends X2Effect_ApplySmokeGrenadeToWorld;
...
event array<X2Effect> GetTileEnteredEffects()
{
	...
	TileEnteredEffects.AddItem(class'X2Ability_MortarStrikes'.static.SmokeMortarEffect());

...
event name CallMeetsCondition(XComGameState_BaseObject kTarget)
{
	...
	`LOG("[X2Condition_MapCheck::CallMeetsCondition()] Count: Disallowed Biomes: "$ DisallowedBiomes.Length $", Disallowed Plots: "$ DisallowedPlots.Length $", Disallowed Parcels: "$ DisallowedParcels.Length ,class'X2DownloadableContentInfo_WotC_SupportStrikes'.static.Log(, true),'WotC_Gameplay_SupportStrikes');
	`LOG("[X2Condition_MapCheck::CallMeetsCondition()] Biome: " $ BattleData.MapData.Biome,class'X2DownloadableContentInfo_WotC_SupportStrikes'.static.Log(, true),'WotC_Gameplay_SupportStrikes');
	`LOG("[X2Condition_MapCheck::CallMeetsCondition()] Plot Type: " $ PlotType ,class'X2DownloadableContentInfo_WotC_SupportStrikes'.static.Log(, true),'WotC_Gameplay_SupportStrikes');
	...
	`LOG("[X2Condition_MapCheck::CallMeetsCondition()] Condition Passed",class'X2DownloadableContentInfo_WotC_SupportStrikes'.static.Log(, true),'WotC_Gameplay_SupportStrikes');
